...
;(function(root, factory) {
    ...
    var regexps = {
        ...
        inPostalCode:/(^(?:11)[0-9]{4}$)|(^(?:1[2-3])[0-9]{4}$)|(^(?:1[4-6])[0-9]{4}$)|(^(?:17)[0-9]{4}$)|(^(?:1[8-9])[0-9]{4}$)|(^(?:2[0-8])[0-9]{4}$)|(^(?:3[0-4])[0-9]{4}$)|(^(?:3[6-9])[0-9]{4}$)|(^(?:4[0-4])[0-9]{4}$)|(^(?:4[5-9])[0-9]{4}$)|(^(?:5[0-3])[0-9]{4}$)|(^(?:5[6-9])[0-9]{4}$)|(^(?:6[0-4])[0-9]{4}$)|(^(?:6[7-9])[0-9]{4}$)|(^(?:7[0-4])[0-9]{4}$)|(^(?:7[5-7])[0-9]{4}$)|(^(?:78)[0-9]{4}$)|(^(?:79)[0-9]{4}$)|(^(?:8[0-5])[0-9]{4}$)|(^(?:9[0-9])[0-9]{4}$)/,
