...
describe("arithmetic checks", function() {
    ...
    describe("is.zero", function() {
        it("should return true if given number is zero", function() {
            expect(is.zero(0)).to.be.true;
        });
        it("should return false if given numbers is not zero", function() {
            expect(is.zero(4)).to.be.false;
            expect(is.zero('0')).to.be.false;
        });
    });
    describe("is.not.zero", function() {
        it("should return true if given number is not zero", function() {
            expect(is.not.zero(3)).to.be.true;
        });
        it("should return false if given number is zero", function() {
            expect(is.not.zero(0)).to.be.false;
        });
    });
    describe("is.any.zero", function() {
        it("should return true if any given number is zero", function() {
            expect(is.any.zero(0, -1, 3)).to.be.true;
            expect(is.any.zero([0, -1, 3])).to.be.true;
        });
        it("should return false if any given numbers are not zero", function() {
            expect(is.any.zero(1, 15, -98)).to.be.false;
            expect(is.any.zero('0', 0.99, 1.01)).to.be.false;
            expect(is.any.zero([1, 15, -98])).to.be.false;
        });
    });
    describe("is.all.zero", function() {
        it("should return true if all given number is zero", function() {
            expect(is.all.zero(0, 1 - 1, -1 + 1)).to.be.true;
            expect(is.all.zero([0, 1 - 1, -1 + 1])).to.be.true;
        });
        it("should return false if all given numbers are not zero", function() {
            expect(is.all.zero(0, 15, -98)).to.be.false;
            expect(is.all.zero('0', 0.99, 1.01)).to.be.false;
            expect(is.all.zero([0, 15, -98])).to.be.false;
        });
    });
    /* is.one */
    describe("is.one", function() {
        it("should return true if given number is one", function() {
            expect(is.one(1)).to.be.true;
        });
        it("should return false if given numbers is not one", function() {
            expect(is.one('1')).to.be.false;
            expect(is.one(4)).to.be.false;
        });
    });
    describe("is.not.one", function() {
        it("should return true if given number is not one", function() {
            expect(is.not.one(3)).to.be.true;
        });
        it("should return false if given number is one", function() {
            expect(is.not.one(1)).to.be.false;
        });
    });
    describe("is.any.one", function() {
        it("should return true if any given number is one", function() {
            expect(is.any.one( 1, -1, 3)).to.be.true;
            expect(is.any.one([1, -1, 3])).to.be.true;
        });
        it("should return false if any given numbers are not one", function() {
            expect(is.any.one(4, 15, -98)).to.be.false;
            expect(is.any.one('1', 0.99, 1.01)).to.be.false;
            expect(is.any.one([4, 15, -98])).to.be.false;
        });
    });
    describe("is.all.one", function() {
        it("should return true if all given number is one", function() {
            expect(is.all.one(1, 2 - 1, -1 + 2)).to.be.true;
            expect(is.all.one([1, 2 - 1, -1 + 2])).to.be.true;
        });
        it("should return false if all given numbers are not one", function() {
            expect(is.all.one(1, -1)).to.be.false;
            expect(is.all.one('1', 1, 1.01)).to.be.false;
            expect(is.all.one([1, -1])).to.be.false;
        });
    });
    /* is.nonZero */
    describe("is.nonZero", function() {
        it("should return true if given number is non zero", function() {
            expect(is.nonZero(1)).to.be.true;
            expect(is.nonZero(-1)).to.be.true;
            expect(is.nonZero('1')).to.be.true;
        });
        it("should return false if given numbers is not non zero", function() {
            expect(is.nonZero(0)).to.be.false;
        });
    });
    describe("is.not.nonZero", function() {
        it("should return true if given number is not non zero", function() {
            expect(is.not.nonZero(0)).to.be.true;
        });
        it("should return false if given number is non zero", function() {
            expect(is.not.nonZero(2)).to.be.false;
        });
    });
    describe("is.any.nonZero", function() {
        it("should return true if any given number is non zero", function() {
            expect(is.any.nonZero( 1, 0)).to.be.true;
            expect(is.any.nonZero([1, 0])).to.be.true;
        });
        it("should return false if any given numbers are not non zero", function() {
            expect(is.any.nonZero(0, 3 - 3)).to.be.false;
            expect(is.any.nonZero([0, 3 - 3])).to.be.false;
        });
    });
    describe("is.all.nonZero", function() {
        it("should return true if all given number is non zero", function() {
            expect(is.all.nonZero(1, '0', -3)).to.be.true;
            expect(is.all.nonZero([1, '0', -3])).to.be.true;
        });
        it("should return false if all given numbers are not non zero", function() {
            expect(is.all.nonZero(1, 0)).to.be.false;
            expect(is.all.nonZero([1, 0])).to.be.false;
        });
    });
    /* is.nonPositive */
    describe("is.nonPositive", function() {
        it("should return true if given number is non positive", function() {
            expect(is.nonPositive(-1)).to.be.true;
            expect(is.nonPositive(0)).to.be.true;
        });
        it("should return false if given numbers is not non positive", function() {
            expect(is.nonPositive(5)).to.be.false;
            expect(is.nonPositive('10')).to.be.false;
        });
    });
    /* is.nonNegative */
    describe("is.nonNegative", function() {
        it("should return true if given number is non negative", function() {
            expect(is.nonNegative(15)).to.be.true;
            expect(is.nonNegative(0)).to.be.true;
        });
        it("should return false if given numbers is not non negative", function() {
            expect(is.nonNegative(-5)).to.be.false;
            expect(is.nonNegative('-10')).to.be.false;
        });
    });
    /* is.perfectSquare */
    describe("is.perfectSquare", function() {
        it("should return true if given number is a perfect square", function() {
            expect(is.perfectSquare(0)).to.be.true;
            expect(is.perfectSquare(1)).to.be.true;
            expect(is.perfectSquare(4)).to.be.true;
            expect(is.perfectSquare(9)).to.be.true;
            expect(is.perfectSquare(16)).to.be.true;
            expect(is.perfectSquare(900)).to.be.true;
        });
        it("should return false if given numbers is not a perfect square", function() {
            expect(is.perfectSquare(17)).to.be.false;
            expect(is.perfectSquare(32)).to.be.false;
            expect(is.perfectSquare(635)).to.be.false;
            expect(is.perfectSquare('-10')).to.be.false;
        });
    });
    /* is.divisibleBy */
    describe("is.divisibleBy", function() {
        it("should return true if given number is divisible by divisor", function() {
            expect(is.divisibleBy(9, 99)).to.be.true;
            expect(is.divisibleBy(8, 8)).to.be.true;
            expect(is.divisibleBy(-8, 24)).to.be.true;
        });
        it("should return false if given number is not divisible by divisor", function() {
            expect(is.divisibleBy(0, 1)).to.be.false;
            expect(is.divisibleBy(1, 14.3)).to.be.false;
            expect(is.divisibleBy(9, 1)).to.be.false;
            expect(is.divisibleBy(18.4, 4)).to.be.false;
        });
    });

    /* is.fibonacci */
    describe("is.fibonacci", function() {
        it("should return true if given number is fibonacci number", function() {
            expect(is.fibonacci(8)).to.be.true;
            expect(is.fibonacci(21)).to.be.true;
            expect(is.fibonacci(89)).to.be.true;
            expect(is.fibonacci(987)).to.be.true;
        });
        it("should return false if given number is not a fibonacci number", function() {
            expect(is.fibonacci(6800)).to.be.false;
            expect(is.fibonacci(5123)).to.be.false;
            expect(is.fibonacci(3004)).to.be.false;
            expect(is.fibonacci(6)).to.be.false;
        });
    });
    /* is.triangular */
    describe("is.triangular", function() {
        it("should return true if given number is a triangular number, else it should return false", function() {
            for (var i = 0; i < 20; i++) {
                if (i == 0 || i == 1 || i == 3 || i == 6 || i == 10 || i == 15) {
                    expect(is.triangular(i)).to.be.true;        
                } else expect(is.triangular(i)).to.be.false;
            }  
        });
    });
});
