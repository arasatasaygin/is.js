...
describe("extension checks", function () {
  ...
  is.otherthing = function (val) {
    return val === 'otherthing';
  };
  is.$update();
  ...
  describe("is.otherthing", function () {
    it("should return true if passed string is 'otherthing'", function () {
      var otherthing = 'otherthing';
      expect(is.otherthing(otherthing)).to.be.true;
    });
    it("should return false if passed string is not 'otherthing'", function () {
      var nothing = 'test';
      expect(is.otherthing(nothing)).to.be.false;
    });
  });
  describe("is.not.otherthing", function () {
    it("should return false if passed string is 'otherthing'", function () {
      var otherthing = 'otherthing';
      expect(is.not.otherthing(otherthing)).to.be.false;
    });
    it("should return true if passed string is not 'otherthing'", function () {
      var nothing = 'test';
      expect(is.not.otherthing(nothing)).to.be.true;
    });
  });
  describe("is.all.otherthing", function () {
    it("should return true if all passed parameters are all 'otherthing'", function () {
      var otherthing = 'otherthing';
      var otherthing2 = 'otherthing';
      expect(is.all.otherthing(otherthing, otherthing2)).to.be.true;
      expect(is.all.otherthing([otherthing, otherthing2])).to.be.true;
    });
    it("should return false if any passed parameter type is not 'otherthing'", function () {
      var otherthing = 'otherthing';
      var nothing = 'test';
      expect(is.all.otherthing(otherthing, nothing)).to.be.false;
      expect(is.all.otherthing([otherthing, nothing])).to.be.false;
    });
  });
  describe("is.any.otherthing", function () {
    it("should return true if any passed parameter type is 'otherthing'", function () {
      var otherthing = 'otherthing';
      var nothing = 'test';
      expect(is.any.otherthing(otherthing, nothing, 'test2')).to.be.true;
      expect(is.any.otherthing([otherthing, nothing, 'test2'])).to.be.true;
    });
    it("should return false if all passed parameter types are not 'otherthing'", function () {
      expect(is.any.otherthing('test', 'test2')).to.be.false;
      expect(is.any.otherthing(['test', 'test2'])).to.be.false;
    });
  });
});
