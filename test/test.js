...
describe('regexp checks', function() {
    ...
    describe('is.all.socialSecurityNumber', function() {
        it('should return true if all given values are socialSecurityNumber', function() {
            expect(is.all.socialSecurityNumber('017-90-7890', '017907890')).to.be.true;
            expect(is.all.socialSecurityNumber(['017-90-7890', '017907890'])).to.be.true;
        });
...
describe('string checks', function() {
    ...
    describe('is.not.capitalized', function() {
        ...
        it('should return false if words are capitalized', function() {
    ...
    describe('is.all.capitalized', function() {
        ...
        it('should return true if the words of all strings are capitalized', function() {
            expect(is.all.capitalized('Test Is Good', 'Hypest Hype')).to.be.true;
            expect(is.all.capitalized(['Test Is Good', 'Hypest Hype'])).to.be.true;
        });
        it('should return false if the words of any strings are not capitalized', function() {
    ...
    describe('is.any.capitalized', function() {
        ...
        it('should return true if the words of any string are capitalized', function() {
            expect(is.any.capitalized('Test Is Good', 'hypest hype')).to.be.true;
            expect(is.any.capitalized(['Test Is Good', 'hypest hype'])).to.be.true;
        });
        it('should return false if the words of all strings are not capitalized', function() {
...
describe('time checks', function() {
    ...
    describe('is.not.day', function() {
        it('should return false if given day string is the day of the date object', function() {
            var time = 1421572235303;
            expect(is.not.day(new Date(time), 'sunday')).to.be.false;
        });
        it('should return true if given day string is not the day of the date object', function() {
            var time = 1421572235303;
    ...
    describe('is.not.month', function() {
        it('should return false if given month string is the month of the date object', function() {
            var time = 1421572235303;
            expect(is.not.month(new Date(time), 'january')).to.be.false;
        });
        it('should return true if given month string is not the month of the date object', function() {
            var time = 1421572235303;
    ...
    describe('is.not.year', function() {
        it('should return false if given year string is the year of the date object', function() {
            var time = 1421572235303;
            expect(is.not.year(new Date(time), 2015)).to.be.false;
        });
        it('should return true if given year string is not the year of the date object', function() {
            var time = 1421572235303;
    ...
    describe('is.not.quarterOfYear', function() {
        it('should return false if given quarter is the the quarter of the date object', function() {
            var time = 1421572235303;
            var date = new Date(time);
            expect(is.not.quarterOfYear(date, 1)).to.be.false;
        });
        it('should return true if given quarter is not the quarter of the date object', function() {
            var time = 1421572235303;
            var date = new Date(time);
...
describe('object checks', function() {
    ...
    describe('is.not.propertyCount', function() {
        it('should return false if given count matches that of the object', function() {
            var obj = {
                test: 'test',
                is: 'is',
                good: 'good'
        ...
        it('should return true if given count does not match that of the object', function() {
            var obj = {
                test: 'test',
                is: 'is'
            };
...
describe('array checks', function() {
    ...
    describe('is.not.sorted', function() {
        it('should return false if given array is sorted', function() {
            var arr1 = [1, 2, 3, 4, 5];
            // default behaviour:
            expect(is.not.sorted(arr1)).to.be.false;
            // extended behaviour:
            expect(is.not.sorted(arr1, '>=')).to.be.false;
            expect(is.not.sorted(arr1, '>')).to.be.false;
            expect(is.not.sorted(arr1, '<=')).to.be.true;
            expect(is.not.sorted(arr1, '<')).to.be.true;

            var arr2 = [5, 4, 4, 3, 1];
            // default behaviour:
            expect(is.not.sorted(arr2)).to.be.true;
            // extended behaviour:
            expect(is.not.sorted(arr2, '>=')).to.be.true;
            expect(is.not.sorted(arr2, '>')).to.be.true;
            expect(is.not.sorted(arr2, '<=')).to.be.false;
            expect(is.not.sorted(arr2, '<')).to.be.true;
        });
